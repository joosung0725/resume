...
📟 **주요 업무** :
 - AI을 활용한 리눅스 서버 운영 스크립트 고도화
 - 반복 업무 자동화를 통한 운영 효율성 증대

🎯 **목적** : 운영 리소스 절감 및 서비스 연속성 확보

🥇 **성과** :
 - 스크립트 최적화: AI를 활용하여 WAS 리눅스 서버 23대의 Cron(스케줄링) 스크립트 작성 시간 단축 및 서비스 자동 시작 설정
 - 보안 컴플라이언스 준수: 리눅스 서버 30대의 계정 패스워드 정기 변경 
 - 상용 was 리눅스 서버 23대의 log 삭제
---
