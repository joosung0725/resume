...
네트워크 트래픽 분산 정책을 적용하여 IT 인프라의 안정성과 운영 효율성을 향상** 그리고 
Fortigate, WAF, IPS 등 다층 보안 시스템 운영 경험을 바탕으로 **외부 공격에 대한 실시간 탐지 및 방어 체계**를 강화하는 등 서비스의 무결성을 유지하는 데 주력하고 있습니다.
